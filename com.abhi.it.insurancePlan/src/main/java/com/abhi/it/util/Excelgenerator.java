...
public class Excelgenerator {
	...
	public void writeHeaderLine() {
		...
		createCell(row, 7, "Denied Reason", style);
		createCell(row, 8, "Terminated Reason", style);
		createCell(row, 9, "Terminated date", style);
		createCell(row, 10, "Benefit Name", style);
	}
